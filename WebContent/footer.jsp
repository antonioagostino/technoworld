...
<footer class="page-footer font-small blue pt-4">
  	<div class="row" id="footerDiv">
  		<div class="col-sm-4">
  			<div class="container text-center" id = "firstCol">
  				<h5 align="left" style="margin-left: 4%;">Trova un negozio</h5>
  		...
  		<div class="col-sm-4">
  			<div class="container" id="secondCol">
				<h5>Seguici sui social</h5>
				<div class="social">
				  <a href="#" id="share-fb" class="sharer button"><i class="fab fa-2x fa-facebook"></i></a>
  		...
  		<div class="col-sm-4">
  			<div class="container" id="thirdCol">
  				<h5>Iscriviti alla newsletter</h5>
  				<p class="small">Resta aggiornato sui nostri prodotti e ricevi offerte personalizzate direttamente nella tua mail</p>
  				<div class="input-group mb-3">
				  <input type="text" class="form-control" placeholder="Indirizzo email" aria-label="Recipient's username" aria-describedby="button-addon2" id="email">
				  <div class="input-group-append">
				    <button class="btn" type="button" id="reg" onclick="registerToNewsletter()"><i class="fas fa-angle-right"></i></button>
				  </div>
				</div>
  			</div>
  		</div>
